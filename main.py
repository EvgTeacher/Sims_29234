...
class Human:
    ...
    def days_indexes(self, day):
        ...
        print('Fuel - {0}'.format(self.car.fuel))
    ...
    def live(self, day):
        ...
        if self.satiety < 20:
            ...
            if self.home.mess > 20:
                print('I want to chill, but there is clean')
                self.clean_home()
            else:
                print('Time to chill')
                self.chill()
...
job_list = {'Java developer': {"salary": 50, "gladness_less": 10},
            ...
            'C++ developer': {"salary": 70, "gladness_less": 8},
            'Php developer': {"salary": 35, "gladness_less": 5}}

brand_of_car = {'BMW': {'fuel': 100, 'strength': 100, 'consumption': 12},
                'Lada': {'fuel': 60, 'strength': 60, 'consumption': 10},
                'Volvo': {'fuel': 100, 'strength': 120, 'consumption': 8},
                'Ferrari': {'fuel': 80, 'strength': 150, 'consumption': 6}}
